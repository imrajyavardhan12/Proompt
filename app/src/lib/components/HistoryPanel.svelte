...
<style>
  ...
  .search::placeholder { color: #5f5f5f; }
  .search:focus {
    outline: none;
    border-color: #3a3a3a;
  }
  ...
  .alert {
    ...
    border: 1px solid rgba(184, 92, 92, 0.20);
    color: #d08c8c;
    border-radius: 10px;
    font-size: 12.5px;
  }
  ...
  .history-card {
    ...
    border-radius: 13px;
    box-shadow: inset 0 1px 0 rgba(255, 255, 255, 0.035), 0 12px 34px rgba(0, 0, 0, 0.12);
  ...
  .pill.image {
    background: rgba(199, 194, 189, 0.10);
    color: #c7c2bd;
  }
